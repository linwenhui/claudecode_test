...
```bash
python .skills/utility/docx-format-replicator/scripts/extract_format.py <template.docx> <output.json>
```

**Example**:
```bash
python .skills/utility/docx-format-replicator/scripts/extract_format.py "HY 研制任务书.docx" format_template.json
```
...
```bash
python .skills/utility/docx-format-replicator/scripts/generate_document.py <format.json> <content.json> <output.docx>
```

**Example**:
```bash
python .skills/utility/docx-format-replicator/scripts/generate_document.py format_template.json new_content.json output_document.docx
```
...
```bash
python .skills/utility/docx-format-replicator/scripts/extract_format.py research_task_template.docx template_format.json
```
...
```bash
python .skills/utility/docx-format-replicator/scripts/generate_document.py template_format.json content1.json document1.docx
python .skills/utility/docx-format-replicator/scripts/generate_document.py template_format.json content2.json document2.docx
...
python .skills/utility/docx-format-replicator/scripts/extract_format.py "Company Template.docx" company_format.json

# For each new document:
python .skills/utility/docx-format-replicator/scripts/generate_document.py company_format.json new_report.json "Monthly Report.docx"
```
...
python .skills/utility/docx-format-replicator/scripts/extract_format.py spec_template.docx spec_format.json

# Generate multiple specs
python .skills/utility/docx-format-replicator/scripts/generate_document.py spec_format.json product_a_spec.json "Product A Spec.docx"
python .skills/utility/docx-format-replicator/scripts/generate_document.py spec_format.json product_b_spec.json "Product B Spec.docx"
```
...
for i, content_file in enumerate(content_files, 1):
    ...
    subprocess.run([
        "python", ".skills/utility/docx-format-replicator/scripts/generate_document.py",
...
```bash
python .skills/utility/docx-format-replicator/scripts/extract_format.py --help
python .skills/utility/docx-format-replicator/scripts/generate_document.py --help
```
