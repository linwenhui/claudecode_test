...
```bash
npm install --prefix .skills/utility/browser
```

## Start Chrome

```bash
.skills/utility/browser/scripts/start.js              # Fresh profile
.skills/utility/browser/scripts/start.js --profile    # Copy your profile (cookies, logins)
```
...
```bash
.skills/utility/browser/scripts/nav.js https://example.com
.skills/utility/browser/scripts/nav.js https://example.com --new
```
...
```bash
.skills/utility/browser/scripts/eval.js 'document.title'
.skills/utility/browser/scripts/eval.js 'document.querySelectorAll("a").length'
```
...
```bash
.skills/utility/browser/scripts/screenshot.js
```
...
```bash
.skills/utility/browser/scripts/pick.js "Click the submit button"
```
